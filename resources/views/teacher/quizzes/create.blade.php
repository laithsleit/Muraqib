@extends('layouts.app')
@section('title', 'New Quiz — Muraqib')
...
@section('content')
    ...
    <form action="{{ route('teacher.quizzes.store', $subject) }}" method="POST">
        @csrf
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('duration_minutes') is-invalid @enderror" id="duration_minutes" name="duration_minutes" value="{{ old('duration_minutes', 30) }}" min="1" max="300" required>
        ...
        <div class="card mb-4" style="background: var(--primary-light); border-color: var(--primary);">
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" class="form-control @error('score_threshold') is-invalid @enderror" id="score_threshold" name="score_threshold" value="{{ old('score_threshold') }}" placeholder="{{ config('anticheat.default_threshold') }}" min="1" required style="max-width: 200px;">
